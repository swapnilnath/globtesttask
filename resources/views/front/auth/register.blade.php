            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-12">
                        <div class="login-box">
                            <div class="user-reg-form-ttl">Sign Up</div>
                            <hr>
                            ...
                            <div class="reg_box">
                                {!! Form::open([
                                    ...
                                    'route' => 'front.register', 'files'=>true
                                ]) !!}
                                ...
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    <label class="control-label col-xl-4 col-lg-4 col-12 text-left">User name :</label>
                                    <div class="col-xl-8 col-lg-8 col-12">
                                        <input type="text" class="form-control" name="name" placeholder="Email Address / Username">
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group {{ $errors->has('avatar') ? ' has-error' : '' }}">
                                    <label class="control-label col-xl-4 col-lg-4 col-12 text-left">Profile Image:</label>
                                    <div class="col-xl-8 col-lg-8 col-12">
                                        <input type="file" class="form-control" name="avatar" placeholder="Password" />
