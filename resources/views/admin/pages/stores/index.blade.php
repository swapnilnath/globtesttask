		...
		<div class="col-lg-12">
			<div class="ibox ">
				<div class="ibox-content">
					<div class="col-md-12">
						<a href="{{ route('admin.store.create')  }}" class="btn btn-success m-b pull-right" ><i class="fa fa-plus"></i> Add Store</a>
...
<script type="text/javascript">
	$(document).on("click","a.deletestore",function(e){
		var row = $(this);
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{route('admin.store.delete',[''])}}"+"/"+id,
					type: 'post',
	...
	$(document).on("click","a.change_status",function(e){
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{ route('admin.store.change_status','replaceid') }}",
					type: 'post',
					data: {"_method": 'post',
						'id':id,
						"_token": "{{ csrf_token() }}"
