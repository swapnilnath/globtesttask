                    ...
                    @foreach($stores as $post)
                        ...
                        <div class="col-md-12" style="margin-top: 2em;">
                            <div class="blog-box">
                                <div class="bb-img">
                                    @if($post->store_image)
                                        <img src=" {{ asset('storage/store_image/'.'/'.$post->store_image) }}" alt="" style="max-width: 100px;max-height: 100px;">
                                    @else
                                        <img src=" {{ asset('uploads/store_image/default.png') }}" alt="" style="max-width: 100px;max-height: 100px;">
                                    @endif
